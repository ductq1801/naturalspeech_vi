...
class SynthesizerTrn(nn.Module):
    ...
    def __init__(self, n_vocab, spec_channels, segment_size, hps_models,use_sdp=True, **kwargs):
        ...
        if use_sdp:
            self.dp = StochasticDurationPredictor(**hps_models.stochastic_duration_predictor)
        else:
