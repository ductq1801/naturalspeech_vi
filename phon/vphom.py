...
def convert(word, dialect, chao, eight, nosuper, glottal, phonemic, delimit):
    ...
    return seq
#{n,c,s,o} Specify dialect region (Northern, Central, Southern) or spelling pronunciation
class vphome():
    def __init__(self,dialect=None,chao=None,glottal=None,eight=None,nosuper=None,phonemic=None,delimit=None,ortho=None,tokenize=None):
        self.chao = False
        self.delimit = ''
        self.dialect = 'n'
        self.nosuper = False
